...
def seed():
    ...
    # 1. Ensure subscriber user exists
    users = list(User.objects.filter(email='soundarya.p331@gmail.com'))
    if not users:
        user, created = User.objects.get_or_create(
            username='soundarya.p331@gmail.com',
    ...
    for user in users:
        profile, _ = UserProfile.objects.get_or_create(
            user=user,
            defaults={'business_name': 'Soundarya Studio — Tech & Design', 'phone': '+91 98765 43210'}
        )
