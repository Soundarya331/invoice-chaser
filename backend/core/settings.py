...
# Database
# Default to local SQLite for instant testing, easily configurable to PostgreSQL/Neon via env
DATABASES = {
    'default': {
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # We will add auth tokens in step 2
    ],
